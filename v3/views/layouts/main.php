...
<head>
    ...
    <link rel="mask-icon" href="<?= Url::to('/favicon/safari-pinned-tab.svg') ?>" color="<?= Settings::$colors['faviconSafariColor'] ?>">
    <link rel="shortcut icon" href="<?= Url::to('/favicon/favicon.ico') ?>">
    ...
    <meta name="msapplication-config" href="<?= Url::to('/favicon/browserconfig.xml') ?>">
