<?php
    ...
    class SemantictDropDown extends Widget
    {
        /**
        ...
        public function init()
        {
            ...
            parent::init();
            Html::addCssClass($this->options, ['widget' => "ui dropdown $this->addClass"]);
        }
        ...
        protected function renderItems($items, $options)
        {
            ...
            foreach ($items as $item) {
                ...
                $icon = array_key_exists('icon', $item) ? "<i class= '" . $item['icon'] . " icon'></i>" : "";
                $label = $icon . ($encodeLabel ? Html::encode($item['label']) : $item['label']);

                $itemOptions = ArrayHelper::getValue($item, 'options', ['class' => 'item']);
            ...
            return Html::tag('div', $this->label . "<i class='$this->icon icon'></i><div class='menu'>" . 
                    implode("\n", $lines) . "</div>", $options);
        }
    }
?>
